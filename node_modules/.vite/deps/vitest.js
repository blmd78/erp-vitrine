...
var _lazyMatch = () => {
  var __lib__ = (() => {
    var m2 = Object.defineProperty, V = Object.getOwnPropertyDescriptor, G = Object.getOwnPropertyNames, T = Object.prototype.hasOwnProperty, q = (r, e) => {
      for (var n in e) m2(r, n, { get: e[n], enumerable: true });
    }, H = (r, e, n, a3) => {
      if (e && typeof e == "object" || typeof e == "function") for (let t of G(e)) !T.call(r, t) && t !== n && m2(r, t, { get: () => e[t], enumerable: !(a3 = V(e, t)) || a3.enumerable });
      return r;
    }, J = (r) => H(m2({}, "__esModule", { value: true }), r), w = {};
    q(w, { default: () => re });
    var A = (r) => Array.isArray(r), d = (r) => typeof r == "function", Q = (r) => r.length === 0, W = (r) => typeof r == "number", K = (r) => typeof r == "object" && r !== null, X = (r) => r instanceof RegExp, b = (r) => typeof r == "string", h3 = (r) => r === void 0, Y = (r) => {
      ...
      if (v(e)(a3) && a3.index === r.length) return a3.output;
      ...
      return (a3) => {
        ...
        const u = a3.index;
        if (u > t) {
          if (!h3(e) && !a3.options.silent) {
            const s2 = a3.input.slice(t, u), c = d(e) ? e(s2, o, String(t)) : e;
            h3(c) || a3.output.push(c);
          }
      ...
      return g((o) => {
        ...
        if (u) {
          if (!h3(e) && !o.options.silent) {
            const s2 = d(e) ? e(...u, o.input, String(o.index)) : e;
            h3(s2) || o.output.push(s2);
          }
      ...
      if (n.input.startsWith(r, n.index)) {
        if (!h3(e) && !n.options.silent) {
          const t = d(e) ? e(r, n.input, String(n.index)) : e;
          h3(t) || n.output.push(t);
        }
    ...
    }, tr = (r, e) => C3(r, 0, 1), f3 = (r, e) => C3(r, 0, 1 / 0), x = (r, e) => {
      const n = r.map(v);
      return g(_(M((a3) => {
      ...
      const n = v(r);
      return (a3) => {
        const t = a3.index, o = a3.output.length, u = n(a3);
        return (!u || e) && (a3.index = t, a3.output.length !== o && (a3.output.length = o)), u;
      };
    }, _ = (r, e) => {
      const n = v(r);
      return n;
      ...
      return (e) => {
        ...
        return (t) => {
          ...
          const u = t.index, s2 = (o = t.cache)[a3] || (o[a3] = /* @__PURE__ */ new Map()), c = s2.get(u);
      ...
      let e = 0;
      for (let n = 0, a3 = r.length; n < a3; n++) e = e * 26 + P.indexOf(r[n]) + 1;
      return e;
    }, S = (r, e) => {
      if (e < r) return S(e, r);
      const n = [];
      for (; r <= e; ) n.push(r++);
      return n;
    }, or = (r, e, n) => S(r, e).map((a3) => String(a3).padStart(n, "0")), R = (r, e) => S(O(r), O(e)).map(ir), p3 = (r) => r, z = (r) => ur((e) => rr(e, r, { memoization: false }).join("")), ur = (r) => {
      const e = {};
      return (n) => e[n] ?? (e[n] = r(n));
    }, sr = i(/^\*\*\/\*$/, ".*"), cr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/, (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`), lr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/, (r, e, n, a3) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a3.replaceAll(",", "|").replaceAll(".", "\\.")})`), y = i(/\\./, p3), pr = i(/[$.*+?^(){}[\]\|]/, (r) => `\\${r}`), vr = i(/./, p3), hr = i(/^(?:!!)*!(.*)$/, (r, e) => `(?!^${L(e)}$).*?`), dr = i(/^(!!)+/, ""), fr = l([hr, dr]), xr = i(/\/(\*\*\/)+/, "(?:/.+/|/)"), gr = i(/^(\*\*\/)+/, "(?:^|.*/)"), mr = i(/\/(\*\*)$/, "(?:/.*|$)"), _r = i(/\*\*/, ".*"), j = l([xr, gr, mr, _r]), Sr = i(/\*\/(?!\*\*\/)/, "[^/]*/"), yr = i(/\*/, "[^/]*"), N = l([Sr, yr]), k = i("?", "[^/]"), $r = i("[", p3), wr = i("]", p3), Ar = i(/[!^]/, "^/"), br = i(/[a-z]-[a-z]|[0-9]-[0-9]/i, p3), Cr = i(/[$.*+?^(){}[\|]/, (r) => `\\${r}`), Mr = i(/[^\]]/, p3), Er = l([y, Cr, br, Mr]), B2 = x([$r, tr(Ar), f3(Er), wr]), Pr = i("{", "(?:"), Or = i("}", ")"), Rr = i(/(\d+)\.\.(\d+)/, (r, e, n) => or(+e, +n, Math.min(e.length, n.length)).join("|")), zr = i(/([a-z]+)\.\.([a-z]+)/, (r, e, n) => R(e, n).join("|")), jr = i(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) => R(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase()), Nr = l([Rr, zr, jr]), I = x([Pr, Nr, Or]), kr = i("{", "(?:"), Br = i("}", ")"), Ir = i(",", "|"), Fr = i(/[$.*+?^(){[\]\|]/, (r) => `\\${r}`), Lr = i(/[^}]/, p3), Zr = E(() => F), Dr = l([j, N, k, B2, I, Zr, y, Fr, Ir, Lr]), F = x([kr, f3(Dr), Br]), Ur = f3(l([sr, cr, lr, fr, j, N, k, B2, I, F, y, pr, vr])), Vr = Ur, Gr = z(Vr), L = Gr, Tr = i(/\\./, p3), qr = i(/./, p3), Hr = i(/\*\*\*+/, "*"), Jr = i(/([^/{[(!])\*\*/, (r, e) => `${e}*`), Qr = i(/(^|.)\*\*(?=[^*/)\]}])/, (r, e) => `${e}*`), Wr = f3(l([Tr, Hr, Jr, Qr, qr])), Kr = Wr, Xr = z(Kr), Yr = Xr, $ = (r, e) => {
...
var parse = function(p3) {
  var _a3, _b;
  const root = ((_b = (_a3 = _PATH_ROOT_RE.exec(p3)) == null ? void 0 : _a3[0]) == null ? void 0 : _b.replace(/\\/g, "/")) || "";
...
// node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@24.3.0_jiti@2.5.1_jsdom@26.1.0_lightningcss@1.30.1_terser@5.39.0_yaml@2.8.1/node_modules/vitest/dist/chunks/utils.XdZDrNZV.js
...
// node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@24.3.0_jiti@2.5.1_jsdom@26.1.0_lightningcss@1.30.1_terser@5.39.0_yaml@2.8.1/node_modules/vitest/dist/chunks/_commonjsHelpers.BFTU3MAI.js
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-WJ4R3AAK.js")).default;
...
// node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@24.3.0_jiti@2.5.1_jsdom@26.1.0_lightningcss@1.30.1_terser@5.39.0_yaml@2.8.1/node_modules/vitest/dist/chunks/date.Bq6ZW5rf.js
var RealDate = Date;
var now2 = null;
...
// node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@24.3.0_jiti@2.5.1_jsdom@26.1.0_lightningcss@1.30.1_terser@5.39.0_yaml@2.8.1/node_modules/vitest/dist/chunks/vi.bdSIJ99Y.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
function createExpectPoll(expect2) {
  return function poll(fn2, options = {}) {
    var _a3;
    const state = getWorkerState();
    const defaults = ((_a3 = state.config.expect) == null ? void 0 : _a3.poll) ?? {};
...
function recordAsyncExpect2(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    test5.onFinished.push(() => {
      var _a3;
      if (!resolved) {
        const processor = ((_a3 = globalThis.__vitest_worker__) == null ? void 0 : _a3.onFilterStackTrace) || ((s2) => s2 || "");
        const stack = processor(error.stack);
        console.warn([
          `Promise returned by \`${assertion}\` was not awaited. `,
          "Vitest currently auto-awaits hanging assertions at the end of the test, but this will cause the test to fail in Vitest 3. ",
...
var SnapshotPlugin = (chai2, utils) => {
  ...
  utils.addMethod(chai2.Assertion.prototype, "toMatchInlineSnapshot", function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
    ...
    const isInsideEach = test5.each || ((_a3 = test5.suite) == null ? void 0 : _a3.each);
            ...
            timersPromisesModule.setInterval = (delay, value, options = {}) => ({
              [Symbol.asyncIterator]: () => {
                ...
                return {
                  next: async () => {
                    var _a3, _b;
                    if (((_a3 = options.signal) == null ? void 0 : _a3.aborted) && !hasThrown) {
                      hasThrown = true;
...
var FakeTimers = class {
  ...
  useFakeTimers() {
    ...
    if (!this._fakingTime) {
      ...
      if (((_b = (_a3 = this._userConfig) == null ? void 0 : _a3.toFake) == null ? void 0 : _b.includes("nextTick")) && isChildProcess()) throw new Error("process.nextTick cannot be mocked inside child_process");
...
// node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@24.3.0_jiti@2.5.1_jsdom@26.1.0_lightningcss@1.30.1_terser@5.39.0_yaml@2.8.1/node_modules/vitest/dist/chunks/benchmark.CYdenmiT.js
...
// node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@24.3.0_jiti@2.5.1_jsdom@26.1.0_lightningcss@1.30.1_terser@5.39.0_yaml@2.8.1/node_modules/vitest/dist/chunks/index.CdQS2e2Q.js
...
// node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@24.3.0_jiti@2.5.1_jsdom@26.1.0_lightningcss@1.30.1_terser@5.39.0_yaml@2.8.1/node_modules/vitest/dist/index.js
